...
2 - Sintony - https://www.google.com/fonts/specimen/sintony
...
5 - 	Images used from Pixabay.
	...
	Slider:
	------
	https://pixabay.com/en/apple-diet-face-food-fresh-fruit-19309/

        Image below slider:
        -------------------
       https://pixabay.com/en/apple-health-woman-diet-meals-841169/

6 - Customizer code credit: All the code taken from github https://github.com/justintadlock/trt-customizer-pro

/*-----------------------------------------------------------------------------------*/
/* Copyright */
/*-----------------------------------------------------------------------------------*/

Nutrigen WordPress Theme, Copyright 2018 by Flythemes
Nutrigen is distributed under the terms of the GNU GPL v2 or later.
...
Nutrigen Pro version
==========================================================
Nutrigen pro version is compatible with GPL licensed.
